//============================================================
// An Arduino Sketch to flash an LED on pin D8 and another on
...
void setup() {
	// Enable LED pins D8, D9 & D13.
	pinMode(8, OUTPUT);
	pinMode(9, OUTPUT);
	pinMode(LED_BUILTIN, OUTPUT);
	
	// Enable Timer/counter 1.
	// D8/PB0 = COMP1A toggles at 43,692 roughly 2/3 of the MAX.
    // D9/PB1 = COMP1B toggles at 21,845 roughly 1/3 of the MAX.
...
ISR(TIMER1_COMPA_vect) {
	// Toggle pin D8 (PB0) every interrupt.
	PINB |= (1 << PINB0);
}
