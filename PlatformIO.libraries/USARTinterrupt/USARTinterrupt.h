...
//============================================================
// USARTxxx defines to use libPrintf instead of function call.
// This will only be used in the EEPROM & TWI chapters as I 
// converted to libPrintf for all USART output but didn't 
// change the code in those chapters until after submitting the
// book. My bad.
//
//Apologies if you have had to read this!
//
// Norman Dunbar
// 21 August 2023.

#define USARTwriteText(s) printf("%s", (s))
#define USARTwriteTextln(s) printf("%s\n", (s))
#define USARTwriteInt(d) printf("%d",(d))
#define USARTwriteByte(b) printf("%c", (b))
#define USARTwriteIntHEX(x) printf("%X", (x))
